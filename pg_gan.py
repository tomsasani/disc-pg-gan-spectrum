...
def simulated_annealing(
    ...
    pg_gan = PG_GAN(generator, disc, iterator, parameters, seed, use_entropy = use_entropy)

    # wandb.init(
    #     # set the wandb project where this run will be logged
    #     project=f"mutator-ml-im",
...
class PG_GAN:
    ...
    def __init__(self, generator, disc, iterator, parameters, seed, use_entropy):
    ...
    def train_step(self, real_regions, outname = None):
